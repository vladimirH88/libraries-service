...
export class migrations1672842339973 implements MigrationInterface {
    name = 'migrations1672842339973'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "libraries"."roles" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "active" boolean NOT NULL, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "libraries"."employees" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "patronymic" character varying NOT NULL, "surname" character varying NOT NULL, "email" character varying NOT NULL, "employment_date" TIMESTAMP NOT NULL DEFAULT now(), "fired_date" TIMESTAMP, "password" character varying NOT NULL, "login" character varying NOT NULL, "active" boolean NOT NULL DEFAULT false, "position_id" integer, "library_id" integer, "role_id" integer, CONSTRAINT "PK_b9535a98350d5b26e7eb0c26af4" PRIMARY KEY ("id"))`);
